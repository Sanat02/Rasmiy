...
@Data
@Builder
public class EducationExtensionCrWeekStatementDto {
    ...
    @ValidateLanguage(message = "lesson letters should be only kyrgyz/russian!")
    @NotBlank(message = "F shouldn't be null or empty!")
    private String lesson;


    @NotNull(message = "Extension week shouldn't be null")
